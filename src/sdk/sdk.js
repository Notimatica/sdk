...
const Notimatica = {
  ...
  strings: {
    ...
    ru: {
      'popup.welcome': 'Подписаться на {project}',
      'popup.subscribe': 'Хотите получать уведомления от {project}?',
      'popup.subscribed': 'Вы подписаны на уведомления от {project}.',
